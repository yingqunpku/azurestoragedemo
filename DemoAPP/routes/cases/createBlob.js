...
module.exports = function(account, key, host){
	...
	blobSvc.createBlockBlobFromLocalFile(conf.containerName, conf.blobFile, conf.blobFile, {maximumExecutionTimeInMs: conf.caseInterval}, function(error, result, response){
